...
{
    /// <inheritdoc />
    public partial class AddUserAndUnitAndCollaboratorDefault : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
               table: "usuarios",
               columns: new[] { "id", "nome_do_usuario", "senha", "status", "permissoes" },
               values: new object[] { user.Id, user.Login, HashPassword(user.Password), user.Status, user.Role }
           );
